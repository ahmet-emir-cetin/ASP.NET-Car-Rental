...
(function($) {
    ...
    $(document).ready(function() {
        ...
        // var datepickers = $("#datepicker, #datepicker2, #datepicker3, #datepicker4, #datepicker5, #datepicker6, #datepicker7, #datepicker8, #datepicker9, #datepicker10, #datepicker11");

        // datepickers.datepicker({
        //     autoclose: true,
        //     todayHighlight: true,
        //     startDate: today, // Bugünden önceki tarihleri engelle
        ...
        //     // Diğer tarih seçicilerin tarih aralığını güncelle
        //     $("#datepicker2").datepicker('setStartDate', startDate);
        //     $("#datepicker2").datepicker('setEndDate', maxEndDate);

        //     // Eğer diğer tarih seçicileriniz varsa, burada da benzer işlemleri yapabilirsiniz
        // });
        var today = new Date();
        var endOfYear = new Date(today.getFullYear(), 11, 31); // Aralık ayının son günü

        // Başlangıç tarih seçicisini ayarla
        ...
        $('#datepicker2').on('changeDate', function() {
            ...
            if (startDate && endDate) {
                ...
                $('#car-pickup-btn').text(daysDiff + ' Gün Kirala');
                $('#rentalDays').attr('value', daysDiff);
            } else {
                $('#car-pickup-btn').text('Kirala');
            }
        });

        // Form gönderimi sırasında tarihleri "dd-mm-yyyy" formatına dönüştür
        $('#reservationForm').on('submit', function(e) {
            ...
            // Gizli inputlara formatlanmış tarihleri yerleştir
            $('#DatePickup').val(formattedStartDate);
            $('#DateDropoff').val(formattedEndDate);
        });

        // Tarih formatını dd-mm-yyyy'ye dönüştüren fonksiyon
